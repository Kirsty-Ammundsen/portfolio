  ...
  return (
    <div class="h-screen bg-[#b9bab9] overflow-hidden">
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        /> */}
        <h2 class="bg-white hidden lg:block text-4xl py-6 px-4
        rounded-lg opacity-60 ml-20 mr-28 font-cursive">'welcome to my homepage - here you can find out more about me, see my projects, and get in contact'</h2>
      </div>
