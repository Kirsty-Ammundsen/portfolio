    ...
    <div class="h-screen bg-primary md:overflow-hidden">
      ...
      <div class="flex flex-col-reverse md:flex-row md:justify-between">
        <div class="flex items-center justify-center ">
          <p class="bg-lightGray rounded-lg text-xl p-4 py-6 md:text-2xl md:py-12 md:px-6 md:ml-20 ">Resume - <a class="hover:text-green-800 font-bold" href="https://docs.google.com/document/d/1E1kWHfyMwnAf44LNHI8WtqTw7mKqbCDaPjlws0O73aA/export?format=pdf">download my resume</a>
          <br/>
          <br/>
        ...
        <div class="md:mt-10 relative flex flex-col items-end md:justify-between md:float-right md:h-screen">
          <h1 class="text-3xl md:text-4xl md:pt-4 pr-4">contact info</h1>
